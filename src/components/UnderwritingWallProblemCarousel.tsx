...
const scenarios = [
  ...
  {
    id: 3,
    badge: "С UNDERWRITING WALL",
    title: "Когда Есть Модель",
    items: [
      "Реальные цифры",
      "Все расходы учтены",
...
export const UnderwritingWallProblemCarousel = () => {
                  ...
                  <ul className="space-y-3">
                    {scenario.items.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        ...
                        <span className={`text-foreground/80 ${scenario.type === "reality" ? "text-red-300/90" : ""}`}>
                          {item}
                        </span>
                      </li>
                    ))}

...
const scenarios = [
  {
    id: 1,
    badge: "НАШЁЛ ОБЪЕКТ",
    title: "Выглядит Отлично",
    items: [
      "Хорошая локация",
      "Адекватная цена €78K",
      "Застройщик обещает надёжность",
      "Готов платить депозит"
    ],
    type: "start" as const
  },
  {
    id: 2,
    badge: "ПРОВЕРИЛ BLACKLIST",
    title: "Красный Флаг!",
    items: [
      "3 проекта задержка 12+ мес",
      "8 судебных исков",
      "Нет разрешения",
      "Долг банку €2M",
      "Сменил название 2024"
    ],
  ...
  },
  {
    id: 3,
    badge: "SAVED",
    title: "Решение: Не Покупать",
    items: [
      "Сэкономил €78K основная сумма",
      "Сэкономил €5K судебные",
      "Нервы и время",
      "Стоимость screening: $59/мес"
    ],
    type: "solution" as const
  }
];

export const NegativeScreeningProblemCarousel = () => {
      ...
      <div className="hidden md:block max-w-6xl mx-auto">
        ...
        <div className="flex justify-center">
          <Card className="p-8 bg-gradient-to-br from-primary/5 to-transparent backdrop-blur-md border border-primary/20 rounded-[7px] w-fit max-w-[920px]">
            ...
            <div className="pt-4 border-t border-border/30 text-right">
              <span className="text-sm text-foreground/70">Стоимость: </span>
              <span className="text-lg font-semibold text-primary">$59/мес</span>
            </div>
          </Card>
        </div>
      </div>
